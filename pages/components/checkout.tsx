            ...
            <div className="grid max-w-3xl grid-cols-5 mx-auto overflow-hidden bg-white rounded-md shadow-2xl auto-rows-fr">
                <div className="flex flex-col col-span-3 p-8 space-y-8">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="w-full border border-gray-200 divide-y rounded">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="w-full border border-gray-200 rounded shadow-sm bg-gray-50">
                            <div className="flex flex-row items-center h-10 p-2 space-x-2 text-gray-400">
                    ...
                    <div className="flex flex-col items-start space-y-1">
                        ...
                        <div className="flex flex-row items-center p-1 space-x-2 border border-gray-200 rounded">
                            <div className="px-4 py-1.5 rounded text-violet-800 font-medium text-sm bg-violet-100 flex flex-row items-center space-x-2 cursor-pointer">
                            ...
                            <div className="px-2 py-1.5 text-gray-600 font-medium rounded text-sm flex flex-row items-center space-x-2 cursor-pointer">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="w-full border border-gray-200 divide-y rounded shadow-sm bg-gray-50">
                            <div className="flex flex-row items-center h-10 p-2 space-x-4 text-gray-400">
                                P. IVA
                            </div>
                ...
                <div className="flex flex-col col-span-2 p-8 bg-gray-100">
                    ...
                    <span className="my-3 text-emerald-700">
                    ...
                    <button className="w-full h-10 mt-4 font-medium text-white rounded bg-emerald-600">
                        Paga
                    </button>
                    <div className="flex flex-row items-center mt-1 space-x-1 text-xs text-gray-700">
